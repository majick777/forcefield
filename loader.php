...
// Loader Usage
// ============
// 1. replace all occurrences of forcefield_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new forcefield_loader($args);				// instantiates loader class
// (ie. search and replace 'forcefield_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'forcefield_loader' ) ) {
	...
	class forcefield_loader {
		...
		public function readme_viewer() {
			...
			if ( file_exists( $parser ) ) {
				...
				$readme = new forcefield_readme_parser();
...
if ( !function_exists( 'forcefield_load_prefixed_functions' ) ) {
	function forcefield_load_prefixed_functions() {
		...
		if ( !function_exists( 'forcefield_settings_resources' ) ) {
			function forcefield_settings_resources( $media, $color_picker ) {
				$namespace = forcefield_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
